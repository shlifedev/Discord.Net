...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2009 :  IEquatable<InlineResponse2009>, IValidatableObject
    {
        ...
        public InlineResponse2009(int? depth = default(int?), decimal? duration = default(decimal?), string name = default(string), List<OrgsorgidprojectsprojectidbuildtargetsbuildtargetidbuildsnumberstepsMessages> messages = default(List<OrgsorgidprojectsprojectidbuildtargetsbuildtargetidbuildsnumberstepsMessages>))
        {
            // to ensure "duration" is required (not null)
            if (duration == null)
            {
                throw new InvalidDataException("duration is a required property for InlineResponse2009 and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for InlineResponse2009 and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        public List<OrgsorgidprojectsprojectidbuildtargetsbuildtargetidbuildsnumberstepsMessages> Messages { get; set; }
