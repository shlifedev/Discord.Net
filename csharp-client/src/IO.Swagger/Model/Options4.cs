...
namespace IO.Swagger.Model
{
    ...
    public partial class Options4 :  IEquatable<Options4>, IValidatableObject
    {
        ...
        public Options4(HookTypeEnum hookType = default(HookTypeEnum), List<EventsEnum> events = default(List<EventsEnum>), Object config = default(Object), bool? active = true)
        {
            // to ensure "hookType" is required (not null)
            if (hookType == null)
            {
                throw new InvalidDataException("hookType is a required property for Options4 and cannot be null");
            }
            else
            {
            ...
            if (config == null)
            {
                throw new InvalidDataException("config is a required property for Options4 and cannot be null");
            }
            else
            {
                this.Config = config;
