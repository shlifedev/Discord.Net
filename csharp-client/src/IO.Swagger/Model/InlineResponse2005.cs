...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2005 :  IEquatable<InlineResponse2005>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="InlineResponse2005" /> class.
        /// </summary>
        /// <param name="updatingUserEmail">updatingUserEmail.</param>
        /// <param name="updated">updated (required).</param>
        /// <param name="lines">lines (required).</param>
        public InlineResponse2005(string updatingUserEmail = default(string), string updated = default(string), List<OrgsorgidprojectsprojectidauditlogLines> lines = default(List<OrgsorgidprojectsprojectidauditlogLines>))
        {
            // to ensure "updated" is required (not null)
            if (updated == null)
            {
                throw new InvalidDataException("updated is a required property for InlineResponse2005 and cannot be null");
            }
            else
            {
            ...
            if (lines == null)
            {
                throw new InvalidDataException("lines is a required property for InlineResponse2005 and cannot be null");
            }
            else
            {
                this.Lines = lines;
