...
namespace IO.Swagger.Model
{
    ...
    public partial class OrgsorgidprojectsprojectidbuildtargetsCredentialsSigningCredentialResourceRefKeystore :  IEquatable<OrgsorgidprojectsprojectidbuildtargetsCredentialsSigningCredentialResourceRefKeystore>, IValidatableObject
    {
        ...
        public OrgsorgidprojectsprojectidbuildtargetsCredentialsSigningCredentialResourceRefKeystore(string alias = default(string), bool? debug = default(bool?), string expiration = default(string))
        {
            this.Alias = alias;
            this.Debug = debug;
