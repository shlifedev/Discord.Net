...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse20010 :  IEquatable<InlineResponse20010>, IValidatableObject
    {
        ...
        public InlineResponse20010(string text = default(string), string redirect = default(string), int? priority = default(int?), string scmType = default(string), string billingPlan = default(string), string platform = default(string), string alertType = default(string), bool? autoClear = default(bool?))
        {
            this.Text = text;
