...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2004 :  IEquatable<InlineResponse2004>, IValidatableObject
    {
        ...
        public InlineResponse2004(HookTypeEnum hookType = default(HookTypeEnum), List<EventsEnum> events = default(List<EventsEnum>), Object config = default(Object), bool? active = true, string id = default(string))
        {
            // to ensure "hookType" is required (not null)
            if (hookType == null)
            {
                throw new InvalidDataException("hookType is a required property for InlineResponse2004 and cannot be null");
            }
            else
            {
            ...
            if (config == null)
            {
                throw new InvalidDataException("config is a required property for InlineResponse2004 and cannot be null");
            }
            else
            {
                this.Config = config;
