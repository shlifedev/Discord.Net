...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2007 :  IEquatable<InlineResponse2007>, IValidatableObject
    {
        ...
        public InlineResponse2007(PlatformEnum? platform = default(PlatformEnum?), string label = default(string), string credentialid = default(string), string created = default(string), string lastMod = default(string), OrgsorgidcredentialssigningandroidKeystore keystore = default(OrgsorgidcredentialssigningandroidKeystore), Object links = default(Object))
        {
        ...
        public OrgsorgidcredentialssigningandroidKeystore Keystore { get; set; }
