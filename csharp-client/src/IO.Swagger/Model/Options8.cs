...
namespace IO.Swagger.Model
{
    ...
    public partial class Options8 :  IEquatable<Options8>, IValidatableObject
    {
        ...
        public Options8(List<OrgsorgidprojectsprojectidartifactsdeleteBuilds> builds = default(List<OrgsorgidprojectsprojectidartifactsdeleteBuilds>))
        {
            // to ensure "builds" is required (not null)
            if (builds == null)
            {
                throw new InvalidDataException("builds is a required property for Options8 and cannot be null");
            }
            else
            {
                this.Builds = builds;
